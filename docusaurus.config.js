  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          label: "Start reading",
          href: "/start-reading-ai-paper-summary/",
          position: "left",
        },
        {
          label: "Image Classification",
          href: "/image-classification/deep-inside-convolutional-networks/",
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: "GitHub",
              href: "https://github.com/buffyhridoy/buffytheanalyst/",
            },
            {
              label: "Discord",
              href: "https://discord.gg/usMqNaPczq",
